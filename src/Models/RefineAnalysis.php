...
namespace SilverstripeLtd\AiRefine\Models;

use SilverStripe\ORM\DataObject;

/**
 * Stores the latest persisted refine analysis for a record.
 */
class RefineAnalysis extends DataObject
{
    ...
    private static $table_name = 'RefineAnalysis';
