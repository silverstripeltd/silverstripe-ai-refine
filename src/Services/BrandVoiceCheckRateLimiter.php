...
/**
 * Tracks per-session Brand Voice checks for one member and record pair.
 */
class BrandVoiceCheckRateLimiter
{
    private const SESSION_KEY = 'SilverstripeLtd.AiBrandVoice.CheckRateLimiter';
    ...
    {
        return max(1, (int) Config::inst()->get(BrandVoiceCheckRateLimiter::class, 'max_requests'));
    }

    private function getWindowSeconds(): int
    {
        return max(1, (int) Config::inst()->get(BrandVoiceCheckRateLimiter::class, 'window_seconds'));
    }
